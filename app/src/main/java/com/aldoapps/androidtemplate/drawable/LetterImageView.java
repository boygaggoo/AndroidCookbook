package com.aldoapps.androidtemplate.drawable;
...
import com.aldoapps.androidtemplate.R;

import java.util.Random;

/**
 * Created by aldokelvianto on 09/05/16.
 */
public class LetterImageView extends ImageView {
    ...
    public void setLetter(String letter) {
        mLetter = letter.toUpperCase().charAt(0);
        invalidate();
    }
    ...
    private int randomColor() {
        ...
        String[] colorsArr = getResources().getStringArray(R.array.letter_image_view_colors);
    ...
    private int getColor(){
        return isColorful ? randomColor() : getDefaultColor();
    }
}